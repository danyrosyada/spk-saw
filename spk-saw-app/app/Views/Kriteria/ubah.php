...
<div class="container mt-3 mb-3">
    ...
    <div class="col">
        <form action="<?= base_url("/kriteria/update/" . $kriteria['id_kriteria']) ?> " method="post" enctype="multipart/form-data">
            <?= csrf_field(); ?>
            <div class="row mb-3">
                <label for="nama_kriteria" class="col-sm-2 col-form-label">Nama Kriteria</label>
                <div class="col-sm-8">
                    <input type="text" class="form-control <?= ($validation->hasError('nama_kriteria')) ? 'is-invalid' : '' ?>" id="nama_kriteria" name="nama_kriteria" value="<?= $kriteria['nama_kriteria'] ?>">
